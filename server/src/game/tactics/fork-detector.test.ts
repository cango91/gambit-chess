import { GambitMove, SpecialAttackType, ForkDTO } from '@gambit-chess/shared';
...
describe('Fork Detector', () => {
    ...
    test('should detect a new fork created by a Knight move', () => {
        ...
        previousBoard = new Chess('r3kbnr/ppp1pppp/8/3N4/8/8/PPPPPPPP/R3KBNR w KQkq - 0 1');
        currentBoard = new Chess('r3kbnr/ppN1pppp/8/8/8/8/PPPPPPPP/R3KBNR b KQkq - 0 1');
    ...
    test('should detect a new fork created by a Bishop move', () => {
        ...
        previousBoard = new Chess('r3kbnr/ppp1pppp/8/3N1b2/8/8/PPPPPPPP/R1BQKBNR b KQkq - 0 1');
        currentBoard = new Chess('r3kbnr/ppp1pppp/8/3N4/4b3/8/PPPPPPPP/R1BQKBNR w KQkq - 0 1');
        lastMove = {
    ...
    test('should detect a discovered fork (Pawn moves uncovering Queen fork) which modifies an existing fork and creates a new fork', () => {
         ...
         previousBoard = new Chess('r3k2r/p1n1qppp/1p6/2QPp3/1P6/P4N2/5PPP/R3R1K1 w kq - 0 1');
         currentBoard = new Chess('r3k2r/p1n1qppp/1p1P4/2Q1p3/1P6/P4N2/5PPP/R3R1K1 b kq - 0 1');
         lastMove = {
    ...
    test('should not detect a fork if it already existed before the move', () => {
        ...
        previousBoard = new Chess('b1k1r1nr/p1N1pppp/1p6/8/8/P7/1PPPPPPP/R3KBNR w KQ - 0 1');
        currentBoard = new Chess('b1k1r1nr/p1N1pppp/1p6/8/8/P7/1PPPPPPP/2KR1BNR b - - 0 1');
        lastMove = {
    ...
    test('should detect a fork if an existing fork is modified (different pieces forked)', () => {
        ...
        previousBoard = new Chess('r3kbnr/ppp1pppp/8/3Q3b/8/8/PPPPPPPP/R1B1KBNR w KQkq - 0 1');
        currentBoard = new Chess('r3kbnr/ppp1pppp/8/2Q4b/8/8/PPPPPPPP/R1B1KBNR b KQkq - 0 1');
