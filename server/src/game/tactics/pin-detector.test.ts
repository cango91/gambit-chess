...
describe('Pin Detector', () => {
    ...
    test('should detect a new pin created by a move', () => {
        ...
        currentBoard = new GambitChess('4k3/4n3/8/8/8/8/4Q3/4K3 b - - 0 1');
        previousBoard = new GambitChess('4k3/4n3/8/8/8/8/8/3QK3 w - - 0 1');
    ...
    test('should detect a pin created by moving a piece that uncovers an attack (discovered pin)', () => {
        ...
        previousBoard = new GambitChess('2k5/8/2b5/2N5/8/2R5/8/4K3 w - - 0 1');
        currentBoard = new GambitChess('2k5/8/2b5/8/4N3/2R5/8/4K3 b - - 0 1');
        lastMove = {
    ...
    test('should not detect a pin if it already existed before the move', () => {
        ...
        previousBoard = new GambitChess('4k3/5q2/8/3n4/2B5/P7/8/4K3 w - - 0 1');
        currentBoard = new GambitChess('4k3/5q2/8/3n4/P1B5/8/8/4K3 b - - 0 1');
        lastMove = {
    ...
    test('should detect a pin if an existing pin is resolved by creating a new pin', () => {
        ...
        previousBoard = new GambitChess('4k3/8/B7/1p6/2n5/3q4/8/4K3 w - - 0 1');
        currentBoard = new GambitChess('4k3/8/8/1B6/2n5/3q4/8/4K3 b - - 0 1');
         lastMove = {
