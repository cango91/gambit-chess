import { GambitChess, GambitMove, SpecialAttackType, DiscoveredAttackDTO } from '@gambit-chess/shared';
...
describe('Discovered Attack Detector', () => {
    ...
    test('should detect a simple discovered attack (Bishop moves, reveals Rook attack)', () => {
        ...
        previousBoard = new GambitChess('rnbqkb1r/pppppppp/8/8/8/3B4/PPP1PPPP/RNBQK1NR w KQkq - 0 1'); // Bishop on d3
        currentBoard = new GambitChess('rnbqkb1r/pppppppp/8/8/2B5/8/PPP1PPPP/RNBQK1NR b KQkq - 0 1');  // Bishop on c4
        lastMove = {
    ...
    test('should detect a discovered check (Knight moves, reveals Queen check)', () => {
        ...
        previousBoard = new GambitChess('r1bqkbnr/ppp2ppp/2np4/8/8/3PN3/PPP1QPPP/R1B1KBNR w KQkq - 0 1'); // Knight on e4
        currentBoard = new GambitChess('r1bqkbnr/ppp2ppp/2np4/5N2/8/3P4/PPP1QPPP/R1B1KBNR b KQkq - 0 1'); // Knight on c5
        lastMove = {
    ...
    test('should detect multiple discovered attacks revealed by one move', () => {
        ...
        previousBoard = new GambitChess('4k3/8/2p5/8/R3P2n/5B2/8/4K3 w - - 0 1');
        currentBoard = new GambitChess('4k3/8/2p5/4P3/R6n/5B2/8/4K3 b - - 0 1');
        lastMove = {
    ...
    test('should not detect discovered attack when no attack is revealed', () => {
        ...
        previousBoard = new GambitChess();
        currentBoard = new GambitChess('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1');
        lastMove = {
    ...
    test('should not detect if attack exists after move, but was not blocked before', () => {
        ...
        previousBoard = new GambitChess('rnbqkbnr/p1pppppp/8/8/1R6/8/1PPPPPPP/4KBNR w Kkq - 0 1');
        currentBoard = new GambitChess('rnbqkbnr/p1pppppp/8/8/1R6/2P5/1P1PPPPP/4KBNR b Kkq - 0 1');
        lastMove = {
     ...
     test('should detect discovered attack revealed by a capture', () => {
        ...
        previousBoard = new GambitChess('rnbqkbnr/ppp1pppp/2P5/8/B2p4/4P3/PP1P1PPP/RNBQK1NR w KQkq - 0 1');
        currentBoard = new GambitChess('rnbqkbnr/pPp1pppp/8/8/B2p4/4P3/PP1P1PPP/RNBQK1NR b KQkq - 0 1'); 
        lastMove = {
    ...
    test('should detect discovered attack revealed by en-passant capture', () => {
        ...
        previousBoard = new GambitChess('rnbqkbnr/p1p1pppp/8/1pP5/B7/4P3/PP1P1PPP/RNBQK1NR w KQkq b6 0 1');
        currentBoard = new GambitChess('rnbqkbnr/p1p1pppp/1P6/8/B7/4P3/PP1P1PPP/RNBQK1NR b KQkq - 0 1');
        lastMove = {
